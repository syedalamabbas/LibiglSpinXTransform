...
// Modified by Syed Alam Abbas to use Eigen functions 
...
namespace spinX
{
	...
	public:
		...
		const Quaternion& operator=(const Eigen::Vector3d& v); // assigns a purely real quaternion with imaginary value v
		...
		Quaternion operator+(double c) const;                 // addition / assignment of pure real
